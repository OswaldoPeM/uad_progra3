...
protected:
	...
	unsigned short m_actualMaterial;                                  // wich is the material in use
	...
	int m_numVertices, m_numNormals, m_numUVCoords, m_numFaces,m_numMaterials;// Total number of vertices, normals, UV coords, faces and materials in this model
	...
	vector<Material> m_materials;                           // array of scopes for eac material
...
public:
	...
	void setTextureIdMat(unsigned int i, unsigned int j) { *m_materials[i].textureId = j; }
	...
	unsigned int *getTextureObjId(unsigned int i) const { return m_materials[i].textureId; }
	const char * const getTextureFilename(unsigned int i) const { return m_materials[i].fileName; }
	const char * const getTextureFilename() const { return m_modelTextureFilename; }

	vector<int> getScopeMat(int i) { return m_materials[i].scope; }
};
